...
> Paste below the divider; tables were converted to prose because Substack Markdown tables do not render.
...
[Insert image: assets/default-statusline.png — Claude Code's default two-line status line — the docs example that started it]
